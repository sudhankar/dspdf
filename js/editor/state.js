...
(function () {
  ...
  function updateElement(id,patch,opts){opts=opts||{};for(var p=0;p<state.overlays.length;p++){var list=state.overlays[p];for(var i=0;i<list.length;i++)if(list[i].id===id){Object.assign(list[i],patch);if(opts.commit!==false)pushHistory();emit("change");return list[i];}}return null;}
